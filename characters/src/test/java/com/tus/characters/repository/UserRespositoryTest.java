...
public class UserRespositoryTest {
  ...
  /*  @Test
    void deleteUser_CascadesToCharacters() {
        User user = new User();
        ...
        assertTrue(characters.isEmpty(), "Characters should be deleted when user is removed");
    }*/
    
  /*  @Test
    void testDeleteUser_CascadesToDeleteCharacters() {
        // Arrange: Create a user with two characters
        User user = new User();
        user.setUsername("cascadeUser");
        ...
        c2.setLevel(2);
        c2.setCharacterClass("Mage");
        c2.setCharacterRace("Elf");
        c2.setUser(user);
        ...
        // Assert: Verify characters are also gone
