...
public class UserControllerTest {
	...
	void deleteUser_NotFound_Returns404() throws Exception {
	    doThrow(new ResourceNotFoundException("User", "id", "999"))
